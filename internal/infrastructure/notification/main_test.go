...
var (
	...
	snsNotiEndpoint NotificationEndpoint
)
...
func TestMain(m *testing.M) {
	...
	snsClient = sns.NewSNSClient(awsConf)

	snsNotiEndpoint = NewSNSNotificationEndpoint(snsClient, conf.AWSSNSEmailNotificationTopicArn, conf.AWSSNSPushNotificationTopicArn)
