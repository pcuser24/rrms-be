...
CREATE TYPE "TENANTTYPE" AS ENUM ('INDIVIDUAL', 'FAMILY', 'ORGANIZATION');
...
ALTER TABLE "applications" ADD CONSTRAINT "applications_unit_id_fkey" FOREIGN KEY ("unit_id") REFERENCES "units"("id") ON DELETE CASCADE;
